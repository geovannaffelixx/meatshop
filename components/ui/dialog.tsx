      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="absolute top-4 right-4 rounded-md p-1 text-gray-500 
                       hover:text-red-600 transition-all focus:outline-none 
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-xl font-bold text-center sm:text-left", className)}
      {...props}
    />
  )
}
