...
export class ReviewsController {
  ...
  @Public()
  @ApiOperation({ summary: 'Lista avaliações de unidade/produto, opcionalmente filtradas' })
  ...
  @Public()
  @ApiOperation({ summary: 'Busca uma avaliação de unidade/produto pelo identificador' })
  ...
  @ApiOperation({ summary: 'Avalia a unidade (açougue) responsável pelo pedido' })
  ...
  @ApiResponse({ status: 201, description: 'Avaliação registrada com sucesso' })
  @ApiResponse({ status: 400, description: 'Pedido ainda não foi entregue ou o produto não pertence ao pedido' })
  @ApiResponse({ status: 404, description: 'Pedido não encontrado' })
  @ApiResponse({ status: 409, description: 'Produto já foi avaliado neste pedido' })
  ...
  @ApiResponse({ status: 201, description: 'Avaliação registrada com sucesso' })
  @ApiResponse({ status: 400, description: 'Pedido ainda não foi entregue ou não teve entregador' })
  @ApiResponse({ status: 404, description: 'Pedido não encontrado' })
  @ApiResponse({ status: 409, description: 'Pedido já foi avaliado' })
